<template>
    <div class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
        ...
        <div class="w-full text-gray-700 bg-cream">
            <div class="flex flex-col max-w-screen-xl px-8 mx-auto md:items-center md:justify-between md:flex-row">
                ...
                <nav :class="{ 'transform md:transform-none': !open, 'h-full': open }"
                    ...
                    <a class="px-4 py-2 mt-2 text-sm bg-transparent rounded-lg md:mt-8 md:ml-4 hover:text-gray-900 focus:outline-none focus:shadow-outline"
                        href="#">About Us</a>
                    <button class="px-10 py-3 mt-2 text-sm text-center bg-white text-gray-800 rounded-full md:mt-8 md:ml-4"
                        @click="logout">Login</button>
                    <nuxt-link
        ...
        <div class="bg-cream">
            <div class="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
                ...
                <div class="w-full lg:w-6/12 relative" id="girl">
                    <img data-aos="fade-up" data-aos-once="true" class="w-10/12 mx-auto 2xl:-mb-20" src="/assets/images/index/girl.png" />
                    <!-- calendar -->
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true"
                        class="absolute top-20 -left-6 sm:top-32 sm:left-10 md:top-40 md:left-16 lg:-left-0 lg:top-52 floating-4">
                        <img class="bg-white bg-opacity-80 rounded-lg h-12 sm:h-16" src="/assets/images/index/calendar.svg">
                    </div>
                    <!-- red -->
                    ...
                    <div data-aos="fade-up" data-aos-delay="500" data-aos-once="true"
                        ...
                        <img class="bg-white bg-opacity-80 rounded-lg h-20 sm:h-28" src="/assets/images/index/ux-class.svg" alt="">
                    </div>
                    <!-- congrats -->
                    <div data-aos="fade-up" data-aos-delay="600" data-aos-once="true"
                        ...
                        <img class="bg-white bg-opacity-80 rounded-lg h-12 sm:h-16" src="/assets/images/index/congrat.svg" alt="">
                    </div>
                </div>
            </div>
        ...
        <footer class="mt-12" style="background-color: rgba(37, 38, 65, 1);">
...
body::-webkit-scrollbar-thumb{
  background-image: linear-gradient(-45deg, #fff2e1, #dfaa95);
  border-radius: 50px;
}
